	...
	public String save(HashMap<String, Object> details) throws Exception {
		...
		jdbcTemplate.update(
				...
				new Object[] { (String) details.get("cscode"), (String) details.get("ppdnam"),
						(String) details.get("ppddob"), Integer.parseInt(details.get("ppdnag").toString()),
						(String) details.get("ppdsex"), (String) details.get("ppdcst"), (String) details.get("ppdtel"),
						(String) details.get("sponam"), Integer.parseInt(details.get("sagnxt").toString()),
						(String) details.get("ntitle"), (String) details.get("spodob"),
